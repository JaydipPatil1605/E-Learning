...
import com.app.service.IMentorService;
...
public class MentorController {
	...
	public ResponseEntity<?> uploadFile(@PathVariable MultipartFile notes){
		return ResponseEntity.ok(notesService.uploadNotes(notes));
	}
